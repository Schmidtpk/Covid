...
# JAGS ----------------------------------------------------------------
jags.m <- jags.model( file = "./jags models/estimateR/estimateR.R",
                      data=dat,
                      #inits=init_fun,
                      n.chains=2,
                      n.adapt=100)
...
# save(res,file = "./jags models/save/estimateR_Ger")
...
GGally::ggpairs(data.frame(df[,c("frate[1]",
                                 paste0("i[",Tinit[1],",1]"),
                                 paste0("i[",Ti[1],",1]"),
                                 paste0("i[",T0[1],",1]"),
                                 paste0("i[",T0[1]+10,",1]")),1]))
